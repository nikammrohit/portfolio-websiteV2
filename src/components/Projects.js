...
const projects = [
  ...
  { id: 3, title: 'Facial Recognition Software', description: 'A is a facial recognition program which will be able to locate and identify faces within an image using OpenCV', url: 'https://github.com/nikammrohit/Image-Facial-Recognition' },
